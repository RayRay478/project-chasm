...
var sonic_model = preload("res://entity/CHARACTERS/surivors/sonic.tscn")
var tails_model = preload("res://entity/CHARACTERS/surivors/tails.tscn")
var knux_model = preload("res://entity/CHARACTERS/surivors/knuckles.tscn")
